...
<section class="margin-section">
        ...
        <h2>
                <Fluent.TextBlock variant="body">spooWASDK utilizes HTTP requests to shorten URLs through the spoo.me API. To ensure the functionality of the maximum requests cap amd URL shortening, the following data is collected:
