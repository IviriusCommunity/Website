...
<section style="display: flex; flex-wrap: wrap; align-items: center; justify-content: flex-start; padding: 10px; background: rgba(0, 0, 0, 0.15); border-bottom: 1px solid rgba(205, 205, 205, 0.25);">
  ...
  <Fluent.TextBlock variant="bodyLarge" style="margin-right: 15px; margin-left: 10px; align-items: center;">Ivirius</Fluent.TextBlock>
