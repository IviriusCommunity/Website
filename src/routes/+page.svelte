...
<section style="display: flex; align-items: left; background: rgba(0, 0, 0, 0.15);">
  ...
  <Fluent.TextBlock variant="bodyLarge" style="margin-top: 25px; margin-bottom: 22px; margin-left: 15px">Ivirius</Fluent.TextBlock>
  <Fluent.Button style="margin-top: 25px">Home</Fluent.Button>
</section>
