<script>
  ...
  let open = true;
	...
	const owner = 'IviriusCommunity'; // GitHub repo owner
	const repo = 'Rebound'; // GitHub repo name
				...
				{:else}
					<div class="contributors-container">
						{#each contributors as contributor}
							<Fluent.Button interactive>
								<div class="contributor-info">
									<img class="avatar" src={contributor.avatar_url} alt="{contributor.login}" style="width: 50px; height: 50px; border-radius: 50%;">
									<a class="username" href={contributor.html_url} target="_blank">{contributor.login}</a>
